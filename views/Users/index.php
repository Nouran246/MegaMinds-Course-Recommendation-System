...
<body>
 ...
 -->
        ...
        <div class="col-lg-12">
          <div class="owl-service-item owl-carousel">
            ...
            <div class="item">
              ...
              <div class="down-content">
                <h4>Best Teachers</h4>
                <p>Discover our top-rated educators, recognized for their expertise and passion for teaching. They bring
                  real-world experience into the classroom, inspiring students to excel in computer science.</p>
              </div>
            </div>
            ...
            <div class="item">
              ...
              <div class="down-content">
                <h4>Best Students</h4>
                <p>Meet our outstanding students who have achieved remarkable success through dedication and innovation.
                  Their projects and contributions have made a significant impact in the tech community.</p>
              </div>
            </div>
            ...
            <div class="item">
              ...
              <div class="down-content">
                <h4>Best Education</h4>
                <p>At the heart of our computer science program is a commitment to quality education. We provide
                  students with the tools and resources needed to thrive in a rapidly evolving tech landscape.</p>
              </div>
            </div>
            ...
            <div class="item">
              ...
              <div class="down-content">
                <h4>Best Courses</h4>
                <p>Explore our highly recommended courses designed to equip you with essential skills and knowledge in
                  computer science. Each course is crafted by experienced instructors and tailored to meet industry
                  demands.</p>
              </div>
            </div>
              ...
              <div class="meeting-item">
                ...
                <div class="down-content">
                  ...
                  <a href="meeting-details.php">
                    <h4>Interview preparation Session</h4>
                  </a>
                  <p>Get expert advice on how to ace technical and behavioral interviews, with tips on answering common
                    questions and showcasing your skills.</p>
                </div>
              </div>
            </div>
            <div class="col-lg-6">
              <div class="meeting-item">
                ...
                <div class="down-content">
                  ...
                  <p>Learn effective methods to deliver engaging and interactive lessons in a virtual environment,
                    designed to enhance online education.</p>
                </div>
              </div>
            </div>
            <div class="col-lg-6">
              <div class="meeting-item">
                ...
                <div class="down-content">
                  ...
                  <a href="meeting-details.php">
                    <h4>How to write a cv</h4>
                  </a>
                  <p>Master the art of crafting a professional and compelling CV that highlights your strengths and sets
                    you apart in the job market.</p>
                </div>
              </div>
            </div>
            <div class="col-lg-6">
              <div class="meeting-item">
                ...
                <div class="down-content">
                  ...
                  <p>A hands-on workshop that provides students with practical training and insights into
        ...
        <div class="col-lg-3">
          <div class="right-info">
            <ul>
              ...
              <li>
                <h6>Email Address</h6>
                <span>info@megaminds.edu</span>
              </li>
              <li>
                <h6>Street Address</h6>
                <span>Cairo - Obour</span>
              </li>
              <li>
                <h6>Website URL</h6>
                <span>www.megaminds.edu</span>
              </li>
            </ul>
          </div>
        </div>
  ...
  <a href="javascript:void(0)" id="openLoginModal">Sign In</a>
</div>
 -->
  <!-- Sign-in Modal -->
 ...
 -->
  ...
  <!--   <div class="divider">or</div>
          <button type="button" class="google-btn">
              <img src="../../public/images/google.png" alt="Google Logo" class="google-icon">
              Continue with Google
          </button>
          <button type="button" class="microsoft-btn">
              <img src="../../public/images/microsoft.png" alt="Microsoft Logo" class="google-icon">
              Continue with Microsoft
          </button>
          <button type="button" class="apple-btn">
              <img src="../../public/images/apple.png" alt="Apple Logo" class="google-icon">
              Continue with Apple
          </button> -->

  <!-- Link to switch to Sign-up form -->
  <!--     <p>New to the site? <a href="javascript:void(0)" id="openSignUpModal">Sign up</a></p>
      </form>
  </div>
</div> -->
 ...
 --> <!-- Modal content -->
  ...
  <!--  <label for="password">Password</label>
          <div class="password-container">
              <input type="password" id="signUpPassword" name="password" placeholder="Enter a Password" required>
              <button type="button" class="toggle-password" onclick="togglePassword('signUpPassword')">&#128065;</button>
          </div> -->
 ...
 -->
  ...
  <!--     <p>Already have an account? <a href="javascript:void(0)" id="openLoginModalFromSignUp">Sign in</a></p>
      </form> -->
  <!--  </div>
</div> -->
</body>
