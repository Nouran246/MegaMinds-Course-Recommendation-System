      ...
      <div class="video-overlay header-text">
          <div class="container">
            <div class="row">
              <div class="col-lg-12">
                <div class="caption">
              <h2>Welcome Laila to MEGAMINDS</h2>
              <h5>Where you maximise your mind's potential</h5>
              <div class="main-button-red">
                <div class="scroll-to-section"><button id="join">Join Us Now!</button></div>
              </div>
          </div>
              </div>
            </div>
        ...
        <div class="col-lg-12">
          <div class="owl-service-item owl-carousel">
            ...
            <div class="item">
              ...
              <div class="down-content">
                <h4>Best Teachers</h4>
                <p>Discover our top-rated educators, recognized for their expertise and passion for teaching. They bring real-world experience into the classroom, inspiring students to excel in computer science.</p>
              </div>
            </div>
            ...
            <div class="item">
              ...
              <div class="down-content">
                <h4>Best Students</h4>
                <p>Meet our outstanding students who have achieved remarkable success through dedication and innovation. Their projects and contributions have made a significant impact in the tech community.</p>
              </div>
            </div>
            ...
            <div class="item">
              ...
              <div class="down-content">
                <h4>Best Education</h4>
                <p>At the heart of our computer science program is a commitment to quality education. We provide students with the tools and resources needed to thrive in a rapidly evolving tech landscape.</p>
              </div>
            </div>
            ...
            <div class="item">
              ...
              <div class="down-content">
                <h4>Best Courses</h4>
                <p>Explore our highly recommended courses designed to equip you with essential skills and knowledge in computer science. Each course is crafted by experienced instructors and tailored to meet industry demands.</p>
              </div>
            </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-6 align-self-center">
          <div class="video">
            <a href="https://www.youtube.com/watch?v=HndV87XpkWg" target="_blank"><img src="../../public/images/play-icon.png" alt=""></a>
          </div>
        </div>
      </div>
    </div>
